...
export const addSecondActionCreator = () => ({ type: "SECOND-ADD-POST" });

export const updateSecondInputActionCreator = (title) => ({
  type: "SECOND-UPDATE-INPUT-CHANGE",
  name: title,
});

export const updateSecondActionCreator = (text) => ({
  type: "SECOND-UPDATE-NEW-POST-CHANGE",
  recepie: text,
});

export const removeSecondActionCreator = (idd) => ({
  type: "SECOND-REMOVE",
  idd: idd,
});
